...
object Utils {
    const val PACKAGE_NAME = "pimsupa.scg.surveyin"
    const val app_version_on_firebase = "surveyin_version"
    const val file_name_apk = "SCG-SurveyIn.apk"
    const val pathNameToSaveImage = "SCG SurveyIn"
    const val ftp_directory = "SCG"

    //    const val ftp_folder_app = "Estimate"
    const val SOAP_NAMESPACE = "http://tempuri.org/"
    const val TESTER = "user test"
    const val CLIENT = "user client"
    const val METHOD_GET_DATA = "GetData"
    const val METHOD_SAVE_DATA = "ExecNonQuery"

    const val PERMISSION_READ_WRITE_STORAGE = 52
    const val PERMISSION_CAMERA = 1996
...
//        2019-12-11 15:00  ->  2019-12-11 15:00:00
    ...
    object TakePhoto {
        ...
        val vehicle_directory = "$root/$pathNameToSaveImage/containerNo"
        val vehicle_file_name = "truck_reg_no.jpg"
